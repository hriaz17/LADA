...
def f1_score(y_true, y_pred, average='micro', suffix=False):
    ...
    """
    from seqeval.metrics import f1_score
    print("F1 score generated by seqeval (based on conlleval.pl script): {}\n".format(f1_score(y_true, y_pred)))
...
def precision_score(y_true, y_pred, average='micro', suffix=False):
    ...
    from seqeval.metrics import precision_score
    print("Precision score generated by seqeval (based on conlleval.pl script): {}\n".format(precision_score(y_true, y_pred)))
...
def recall_score(y_true, y_pred, average='micro', suffix=False):
    ...
    """
    from seqeval.metrics import recall_score
    print("Recall score generated by seqeval (based on conlleval.pl script): {}\n".format(recall_score(y_true, y_pred)))
...
def performance_measure(y_true, y_pred):
    ...
    """
    from seqeval.metrics import performance_measure
    print("Performance measures generated by seqeval (based on conlleval.pl script): {}\n".format(performance_measure(y_true, y_pred)))
...
def classification_report(y_true, y_pred, digits=2, suffix=False):
    ...
    """
    from seqeval.metrics import classification_report
    print("Classification report generated by seqeval (based on conlleval.pl script): {}\n".format(classification_report(y_true, y_pred)))
